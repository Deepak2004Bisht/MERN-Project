...
const Auth = () => {
    ...
    // if the user click the login button then setShowUserLogin true and show the login form:-
    const {setShowUserLogin, setUser, axios, navigate} = useContext(AppContext);

    // handle the form submittion and print the value for console and User login form
    ...
    return (
      ...
      // if user click the outside the form the form is close using setShowUserLogin but if user click the form so also form is close
      <div onClick={() => setShowUserLogin(false)} className="fixed top-0 bottom-0 left-0 right-0 z-40 flex items-center justify-content-center bg-black/50 text-gray-600">
