...
const Cart = () => {
  ...
  // Selected another address because user have multiple address
  ...
  // Change address if user click the change address they fill the form and submit the address change if user add the multiple address so by default 0 index (first address) show 
  ...
  // if user login then store the address otherwise not stored address
  useEffect(() => {
    if(user){
      getAddress();
    }
  ...
  // if product.length is greater than 0 and cartItems is available then i will show the carts otherwise not show
  return products.length > 0 && cartItems ? (
    <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
      <div className='flex-1 max-w-4xl'>
        ...
        {/* ---------------------------
          Firstly user click the add product then the product show inside cart 
        ----------------------------*/}
        ...
        {/* ---------------------------
          CONTINUE SHOPPING
          if user click the continue shopping redirect to All Product page
        ---------------------------*/}
        <button onClick={() =>{
          navigate('/products');
          scrollTo(0,0);
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        <div className="mb-6">
          ...
          <select 
            onClick={(e) => setPaymentOptions(e.target.value)} 
